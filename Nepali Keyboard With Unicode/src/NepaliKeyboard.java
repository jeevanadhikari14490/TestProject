...
public class NepaliKeyboard extends JPanel {
	...
	private int UPPER_PADDING = 15; 
									
	private int RIGHT_PADDING = 200; 
										
	private int HORIZONTAL_PADDING = 60;
	...
	// private static BufferedImage img_click[];
	Color c;

	String temp_unclick, temp_click;

	NepaliKeyboard() {
		// setSize(MainFrame.KEYBOARD_LENGTH,MainFrame.KEYBOARD_BREADTH);
		setLayout(null);
		setBounds(20, 370, KEYBOARD_LENGTH, KEYBOARD_BREADTH);
		c = new Color(119, 136, 153);
		setBackground(c);
		/*
		 * img_unclick[]= new BufferedImage[65]; img_click[]= new
		 * BufferedImage[65];
	 ...
	 * NepaliKeyboard keyboard= new NepaliKeyboard(); f.setTitle(
	 * "Nepali Keyboard"); f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	 * f.setLocation(25,25); f.setLayout(null);
	 * f.setSize(MainFrame.WINDOWS_LENGTH,MainFrame.WINDOWS_BREADTH);
	 * f.setVisible(true); f.setBackground(new Color(128,128,128));
	 * f.add(keyboard);
	 * 
	 * }
	 */
