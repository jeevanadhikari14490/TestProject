	...
	public void keyPressed(KeyEvent e) {
		...
		if (!Button.isROMANIZED()) {
			if (e.isShiftDown()) {
				...
				return;
				/*
				 * if (KeyBoardButtonListener.isCapsKey()) { //if(){ //
				 * KeyBoardButtonListener.setIcon(28, "unclick");
				 * //KeyBoardButtonListener.setCapsKey(false);
				 * //actionKey=false; if(capsKey){ capsKey=true;
				 * 
				 * } //}
				 * 
				 * return;
				 * 
				 * 
				 * } else { KeyBoardButtonListener.setIcon(28, "click");
				 * KeyBoardButtonListener.setCapsKey(true); //
				 * Toolkit.getDefaultToolkit().setLockingKeyState(KeyEvent.
				 * VK_CAPS_LOCK, false); capsKey = true; //actionKey = true; }
				 */
